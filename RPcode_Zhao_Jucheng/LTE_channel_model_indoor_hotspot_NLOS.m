...
% this is channel model which apply to devic to device communication
...
%   LOS applicable for 3m < d_D2D < 100m and Sigma = 3
%%
   %global LTE_config;
...
%%     
   ...
   %  total loss between two devices is calculated    
      loss = 43.39*log10(distance_) + 11.5 + 20*log10(fc) +rndnum ;
      Gain = 1/(db2pow(loss));
end
